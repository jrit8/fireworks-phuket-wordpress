...
<label>Preferred package / show<input name="option" maxlength="300" value="<?php echo esc_attr( $proposal ?: ( $fire_show ?: $package_label ) ); ?>"></label>
